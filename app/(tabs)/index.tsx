    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={styles.logoContainer}>
          ...
          <Text style={styles.logoText}>Kasir Digital</Text>
          <Text style={styles.logoSubtext}>Solusi Modern untuk Bisnis Anda</Text>
        </View>
        ...
        <View style={styles.actionsContainer}>
          ...
          >
            <View style={styles.secondaryButtonContent}>
              ...
              <View style={styles.buttonTextContainer}>
                <Text style={styles.secondaryButtonText}>Manajemen Stok</Text>
                <Text style={styles.secondaryButtonSubtext}>Kelola inventori barang</Text>
              </View>
              <Ionicons name="chevron-forward" size={24} color="#00d4ff" />
            </View>
          </TouchableOpacity>
...
<<<<<<< HEAD
				...
				<View style={styles.footer}>
					<Text style={styles.footerText}>
						© 2025 MyKonbini - Powered by Ambatron
					</Text>
				</View>
			</LinearGradient>
		</SafeAreaView>
...
=======
        {/* Footer */}
        <View style={styles.footer}>
          <Text style={styles.footerText}>© 2024 CashierPro - Powered by Expo Router</Text>
        </View>
      </LinearGradient>
    </SafeAreaView>
  );
